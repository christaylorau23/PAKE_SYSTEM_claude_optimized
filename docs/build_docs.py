...
class DocumentationBuilder:
    ...
    def _build_main_docs(self) -> None:
        ...
        for file in main_files:
            ...
            if source_file.exists():
                file_path = Path(file)
                self._convert_markdown_to_html(source_file, self.output_dir / f"{file_path.stem}.html")
    ...
    def _build_architecture_docs(self) -> None:
        ...
        for md_file in arch_dir.rglob("*.md"):
            ...
            output_path = self.output_dir / "architecture" / relative_path.with_suffix(".html")
