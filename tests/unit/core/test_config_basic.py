...
class TestConfigurationImports:
    ...
    def test_pydantic_imports(self):
        ...
        assert hasattr(config_module, "BaseSettings") or "BaseSettings" in str(
...
class TestConfigurationErrorHandling:
    ...
    def test_import_error_handling(self):
        ...
        try:
            with patch(
                "src.pake_system.core.config.get_vault_client", side_effect=ImportError
            ):
