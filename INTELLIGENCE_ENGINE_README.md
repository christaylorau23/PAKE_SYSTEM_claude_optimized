...
DATABASE_URL=postgresql+asyncpg://pake_user:your_password@localhost/pake_intelligence
...
services:
  intelligence-engine:
    ...
    ports:
      - "8000:8000"
    environment:
      - DATABASE_URL=postgresql+asyncpg://pake_user:password@postgres:5432/pake_intelligence
