...
class DeploymentReportGenerator:
    ...
    def generate_recommendations(self):
        ...
        performance_score = self.report.get("performance_metrics", {}).get(
        ...
        security_score = self.report.get("security_status", {}).get(
    ...
    def generate_summary(self) -> str:
        ...
        performance_score = self.report["performance_metrics"].get(
...
def main():
    ...
    parser.add_argument(
        "--output", default="deployment_report.json", help="Output file"
    )
    ...
    generator.add_deployment_info(
        args.image_tag, args.environment, args.deployed_by, args.deployment_time
    )
