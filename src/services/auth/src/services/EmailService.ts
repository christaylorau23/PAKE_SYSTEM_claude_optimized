...
export class EmailService {
  ...
  async sendPasswordResetConfirmation(email: string): Promise<boolean> {
    try {
      ...
      this.logger.error('Failed to send password reset confirmation', {
        email,
        error: error.message,
      });
      return false;
  ...
  private getPasswordResetConfirmationTemplate(): EmailTemplate {
    return {
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                ...
                <p>Your PAKE System account password has been updated. You can now log in with your new password.</p>
      ...
      text: `
        ...
        Your PAKE System account password has been updated. You can now log in with your new password.
