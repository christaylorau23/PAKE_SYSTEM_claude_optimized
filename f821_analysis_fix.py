...
def fix_common_patterns(file_path: Path, errors: List[Tuple[int, str]]) -> Tuple[bool, int]:
    ...
    for match in reversed(init_matches):
        ...
        if method_undefined_names:
            ...
            for name in sorted(method_undefined_names):
                ...
                elif name in ['query_request', 'conversation', 'extraction', 'batch', 'vector_db']:
...
def main():
    ...
    print(f"Top 10 most common undefined names:")
