...
class TestEndToEndIntegrationTDD:
    ...
    def test_gitops_deployment_workflow(self):
        ...
        # Act
        with open(gitops_workflow_path) as f:
            workflow_data = yaml.safe_load(f)
    ...
    def test_monitoring_alerting_integration(self):
        ...
        assert (
            "alerting:" in prometheus_content
        ), "Prometheus should have alerting config"
    ...
    def test_security_scanning_integration(self):
        ...
        security_workflow_path = (
            self.project_root / ".github/workflows/security-scan.yml"
        )
    ...
    def test_argocd_application_integration(self):
        ...
        # Arrange
        staging_app_path = (
            self.project_root / "k8s/argocd/applications/pake-system-staging.yaml"
        )
        production_app_path = (
            self.project_root / "k8s/argocd/applications/pake-system-production.yaml"
        )
