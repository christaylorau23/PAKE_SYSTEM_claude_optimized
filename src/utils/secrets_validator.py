...
This prevents weak password fallbacks and ensures proper secret management
"""
...
class SecretsValidator:
    ...
    def validate_all_secrets(cls) -> None:
        ...
        if weak_secrets:
            error_msg = (
                ...
                f"Never use default or weak passwords in production."
            )
            print(error_msg, file=sys.stderr)
            sys.exit(1)
    ...
    def get_required_secret(cls, secret_name: str) -> str:
        ...
        if cls._is_weak_secret(value):
            error_msg = (
                ...
                f"All secrets must be properly configured with strong values. "
                f"Never use default or weak passwords."
            )
            print(error_msg, file=sys.stderr)
            sys.exit(1)
    ...
    def get_database_config(cls) -> dict[str, Any]:
        ...
        return {
            ...
            "password": cls.get_required_secret("DB_PASSWORD"),
        }
    ...
    def get_redis_config(cls) -> dict[str, Any]:
        ...
        return {
            ...
            "password": cls.get_required_secret("REDIS_PASSWORD"),
        }
