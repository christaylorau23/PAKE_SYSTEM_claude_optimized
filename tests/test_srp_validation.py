...
class TestSRPValidation:
    ...
    def test_plan_builder_srp_compliance(self):
        ...
        from src.services.ingestion.managers.IngestionPlanBuilder import IngestionPlanBuilder
    ...
    def test_orchestrator_srp_compliance(self):
        ...
        from src.services.ingestion.IngestionOrchestratorRefactored import IngestionOrchestratorRefactored
    ...
    def test_single_responsibility_principle(self):
        ...
        plan_methods = [method for method in dir(plan_builder) 
        ...
        for method in plan_methods:
            ...
            assert any(keyword in method_name for keyword in 
                      ['plan', 'build', 'validate', 'optimize', 'config'])
        ...
        execution_methods = [method for method in dir(source_executor) 
        ...
        for method in execution_methods:
            method_name = method.lower()
            assert any(keyword in method_name for keyword in 
                      ['execute', 'source', 'cache', 'web', 'arxiv', 'pubmed'])
