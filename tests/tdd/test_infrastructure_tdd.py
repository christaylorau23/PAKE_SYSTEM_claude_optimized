...
class TestInfrastructureTDD:
    ...
    def test_terraform_variables_validation(self):
        ...
        assert 'variable "database_password"' in content, "Should define database_password variable"
    ...
    def test_terraform_environment_configuration(self):
        ...
        assert 'database_password' in content, "Should define database_password"
