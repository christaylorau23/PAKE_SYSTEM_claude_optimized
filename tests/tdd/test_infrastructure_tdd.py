...
class TestInfrastructureTDD:
    ...
    def test_terraform_variables_validation(self):
        ...
        # Act
        with open(variables_tf_path) as f:
            content = f.read()
    ...
    def test_terraform_outputs_completeness(self):
        ...
        # Act
        with open(outputs_tf_path) as f:
            content = f.read()
    ...
    def test_argocd_application_manifests(self):
        ...
        # Act & Assert
        app_files = ["pake-system-staging.yaml", "pake-system-production.yaml"]
        ...
        for app_file in app_files:
            ...
            assert (
                "destination" in app_data["spec"]
            ), "Should have destination configuration"
