...
class JWTAuthenticationService:
    ...
    async def register_user(
        ...
        try:
            # Validate password
            is_valid, password_errors = self.validate_password_complexity(
    ...
    async def change_password(
        ...
        try:
            ...
            if not self.verify_password(old_password, user["password_hash"]):
                return False, {"errors": ["Current password is incorrect"]}

            # Validate new password
            is_valid, password_errors = self.validate_password_complexity(new_password)
            if not is_valid:
                return False, {"errors": password_errors}
            ...
            # Update password
            success = await self.database_service.update_user_password(
                user_id,
                new_password_hash,
            )
            ...
            return False, {"errors": ["Failed to update password"]}
    ...
    def get_auth_statistics(self) -> dict[str, Any]:
        ...
        return {
            "config": {
                ...
                "password_complexity_required": self.config.require_password_complexity,
            },
            "statistics": {
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        is_valid, errors = auth_service.validate_password_complexity("TestPass123!")
