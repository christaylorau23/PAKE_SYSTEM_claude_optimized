...
- Database passwords (`WealthPass!2025`, `ReplicaPass!2025`)
- API keys (Firecrawl, OpenAI, Alpha Vantage)
- Grafana admin password (`WealthDashboard!!!`)
...
### 3. Secret Management
- **PostgreSQL Secrets**: Database credentials and replication passwords
