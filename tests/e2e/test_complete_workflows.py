...
class TestCompleteUserWorkflows:
    ...
    async def test_complete_user_onboarding_workflow(self, full_system_setup):
        ...
        await db_manager.execute_query(
            """
            INSERT INTO users (user_id, email, password_hash, full_name, organization, research_interests, status, created_at)
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
            """,
            user_id,
            registration_data["email"],
            "hashed_password",  # In real system, would hash the password
