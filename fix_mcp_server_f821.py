...
'''
            ...
            if 'class ' in content:
                ...
                last_class_match = list(re.finditer(r'class \w+\(BaseModel\):', content))[-1]
                insert_pos = last_class_match.end()
                content = content[:insert_pos] + search_request_model + content[insert_pos:]
            else:
                # Insert after imports
                import_end = content.find('\n\n')
                content = content[:import_end] + search_request_model + content[import_end:]
...
'''
            ...
            if search_request_pos != -1:
                ...
                content = content[:insert_pos] + summarize_request_model + content[insert_pos:]
