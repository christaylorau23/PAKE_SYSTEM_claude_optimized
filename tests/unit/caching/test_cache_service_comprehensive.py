...
from tests.factories import UserFactory, SearchResultFactory
...
class TestCacheServiceComprehensive:
    ...
    def cache_service(self, mock_redis, mock_memory_cache):
        ...
        with patch('src.services.caching.cache_service.RedisCache') as mock_redis_class, \
             patch('src.services.caching.cache_service.MemoryCache') as mock_memory_class:
    ...
    async def test_get_cached_data_success(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_functional
    async def test_set_cache_data_success(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_functional
    async def test_delete_cached_data_success(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_functional
    async def test_cache_hit_memory_first(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_functional
    async def test_cache_miss_memory_hit_redis(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_functional
    async def test_cache_miss_both_levels(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_functional
    async def test_set_with_default_ttl(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_functional
    async def test_exists_check_success(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_functional
    async def test_clear_all_cache_success(self, cache_service, mock_memory_cache, mock_redis):
    ...
    async def test_set_with_zero_ttl(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_edge_case
    async def test_set_with_very_long_ttl(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_edge_case
    async def test_set_with_special_characters_key(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_edge_case
    async def test_set_with_complex_nested_data(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_edge_case
    async def test_get_with_empty_key(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_edge_case
    async def test_set_with_none_value(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_edge_case
    async def test_concurrent_access_same_key(self, cache_service, mock_memory_cache, mock_redis):
    ...
    async def test_redis_connection_failure(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_error_handling
    async def test_memory_cache_failure(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_error_handling
    async def test_json_serialization_error(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_error_handling
    async def test_json_deserialization_error(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_error_handling
    async def test_delete_nonexistent_key(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_error_handling
    async def test_redis_timeout_error(self, cache_service, mock_memory_cache, mock_redis):
    ...
    async def test_memory_cache_performance(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_performance
    async def test_bulk_operations_performance(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_performance
    async def test_cache_hit_ratio_performance(self, cache_service, mock_memory_cache, mock_redis):
        """Test cache hit ratio performance"""
        # Arrange
        keys = [f'user:{i}' for i in range(10)]
        mock_memory_cache.get.side_effect = lambda key: UserFactory() if key in keys[:5] else None
    ...
    async def test_sensitive_data_not_logged(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_security
    async def test_cache_key_sanitization(self, cache_service, mock_memory_cache, mock_redis):
    ...
    @pytest.mark.unit_security
    async def test_cache_expiration_security(self, cache_service, mock_memory_cache, mock_redis):
