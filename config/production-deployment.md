...
# The script will output generated passwords - save these securely!
```
...
aws secretsmanager update-secret \
  ...
  --secret-string '{"host":"localhost","port":5432,"database":"pake_system","user":"pake_user","password":"NEW_STRONG_PASSWORD_HERE"}'
