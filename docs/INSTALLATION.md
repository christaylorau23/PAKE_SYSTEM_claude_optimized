...
sudo -u postgres psql -c "ALTER USER pake_user PASSWORD 'your_password';"
```
...
DATABASE_URL=postgresql://pake_user:your_password@localhost:5432/pake_system
...
sudo -u postgres psql -c "CREATE USER pake WITH PASSWORD 'secure_password';"
...
```bash
# Database Configuration
DATABASE_URL=postgresql://pake:secure_password@localhost:5432/pake_system
