...
from src.services.ingestion.managers.IngestionPlanBuilder import IngestionPlanBuilder, PlanBuilderConfig
from src.services.ingestion.managers.SourceExecutor import SourceExecutor
from src.services.ingestion.IngestionOrchestratorRefactored import IngestionOrchestratorRefactored, OrchestratorConfig
...
class TestIngestionPlanBuilder:
    ...
    def test_plan_validation(self):
        ...
        with pytest.raises(ValueError):
            builder.build_plan("test", [
                {"source_type": "web", "query_parameters": {}, "estimated_results": 10},
                {"source_type": "arxiv", "query_parameters": {}, "estimated_results": 10}
            ])
...
class TestSRPCompliance:
    ...
    def test_ingestion_plan_builder_srp(self):
        ...
        plan = builder.build_plan("test", [{"source_type": "web", "query_parameters": {}, "estimated_results": 10}])
