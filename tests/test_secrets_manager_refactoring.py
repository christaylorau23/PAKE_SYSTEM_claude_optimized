...
from security.secrets_manager import SecretsManager, SecretProvider, SecretMetadata
...
class TestSecretsManagerRefactoring:
    ...
    def test_constructor_orchestration(self):
        ...
        with patch.object(SecretsManager, '_validate_provider_parameter') as mock_validate, \
    ...
    def test_validate_provider_parameter_azure_missing_url(self):
        ...
        with pytest.raises(ValueError, match="AZURE_KEY_VAULT_URL environment variable is required"):
            manager._validate_provider_parameter()
    ...
    def test_configure_azure_provider(self):
        ...
        # Verify configuration
        assert manager.provider_config['vault_url'] == 'https://test-vault.vault.azure.net/'
    ...
    def test_configure_google_provider(self):
        ...
        assert manager.provider_config['credentials_path'] == '/path/to/credentials.json'
        assert manager.provider_config['location'] == 'us-central1'
        
        manager.logger.info.assert_called_with("Google Secret Manager provider configured")
    ...
    def test_initialize_provider_client_local(self):
        ...
        with patch.object(manager, '_initialize_local_client') as mock_local:
            ...
            mock_local.assert_called_once()
            manager.logger.info.assert_called_with("✅ local_file client initialized successfully")
    ...
    def test_initialize_provider_client_aws(self):
        ...
        with patch.object(manager, '_initialize_aws_client') as mock_aws:
            manager._initialize_provider_client()
            mock_aws.assert_called_once()
            manager.logger.info.assert_called_with("✅ aws_secrets_manager client initialized successfully")
    ...
    def test_initialize_provider_client_azure(self):
        ...
        with patch.object(manager, '_initialize_azure_client') as mock_azure:
            manager._initialize_provider_client()
            mock_azure.assert_called_once()
            manager.logger.info.assert_called_with("✅ azure_key_vault client initialized successfully")
    ...
    def test_initialize_provider_client_google(self):
        ...
        with patch.object(manager, '_initialize_google_client') as mock_google:
            manager._initialize_provider_client()
            mock_google.assert_called_once()
            manager.logger.info.assert_called_with("✅ google_secret_manager client initialized successfully")
    ...
    def test_initialize_provider_client_failure(self):
        ...
        with patch.object(manager, '_initialize_aws_client') as mock_aws:
            ...
            manager.logger.error.assert_called_with("Failed to initialize aws_secrets_manager client: AWS initialization failed")
    ...
    def test_initialize_aws_client_with_configuration(self):
        ...
        with patch('boto3.Session') as mock_session_class, \
            ...
            manager.logger.info.assert_called_with("AWS Secrets Manager client initialized")
    ...
    def test_initialize_azure_client_with_configuration(self):
        ...
        with patch('azure.identity.DefaultAzureCredential') as mock_credential_class, \
    ...
    def test_initialize_google_client_with_configuration(self):
        ...
        with patch('google.cloud.secretmanager.SecretManagerServiceClient') as mock_client_class:
            ...
            manager.logger.info.assert_called_with("Google Secret Manager client initialized")
